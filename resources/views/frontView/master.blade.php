...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.2.1/js/bootstrap.min.js" integrity="sha384-B0UglyR+jN6CkvvICOB2joaf5I4l3gm9GU6Hc1og6Ls7i6U/mkkaduKaBhlAXv9k" crossorigin="anonymous"></script>
	...
	<link rel="stylesheet" href="{{asset('frontEnd')}}/fontawesome-free-5.3.1-web/fontawesome-free-5.3.1-web/css/all.min.css">
	<link rel="stylesheet" href="{{asset('frontEnd')}}/style.css">
	<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
	<link rel="stylesheet" href="{{asset('frontEnd')}}/style.css">
	<script src="{{asset('frontEnd')}}/jquery-3.2.1.min.js"></script>
	<script src="https://code.jquery.com/jquery-3.3.1.slim.min.js" integrity="sha384-q8i/X+965DzO0rT7abK41JStQIAqVgRVzpbzo5smXKp4YfRvH+8abtTE1Pi6jizo" crossorigin="anonymous"></script>
	<script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.14.6/umd/popper.min.js" integrity="sha384-wHAiFfRlMFy6i5SRaxvfOCifBUQy1xHdJ/yoi7FRNXMRBu5WHdZYu1hA6ZOblgut" crossorigin="anonymous"></script>
	<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.2.1/js/bootstrap.min.js" integrity="sha384-B0UglyR+jN6CkvvICOB2joaf5I4l3gm9GU6Hc1og6Ls7i6U/mkkaduKaBhlAXv9k" crossorigin="anonymous"></script>

	<link rel="stylesheet" href="{{asset('frontEnd')}}/aos.css">
...
<body> 	
		...
		<div class="container-fluid wall shadow">
				<div class="row top-menu">
					<div class="col-1 div1">
						<a href="index.html" ><img src="{{asset('frontEnd')}}/img/IP-logo@3x.png"></a>
					</div>
					<div class="col-9 nav_list" >
						<ul>
							...
							<li>
								<a href="jobcategory.html">Job Category</a>
							</li>
							<li>
								<a href="companylist.html">Company List</a>
							</li>
							<li>
								<a href="joblocation.html">Job Location</a>
							</li>
						</ul>
					</div>
	   ...
	   <div class="container-fluid new_nav">
			...
			<div class="img">
				<a href="index.html" ><img src="img/IP-logo@3x.png"></a>
			</div>
			<div class="sub_nav">
				<ul>
					<li>
